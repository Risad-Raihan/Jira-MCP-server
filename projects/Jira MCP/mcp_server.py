...
async def main():
    ...
    config = JIRAConfig(
        base_url=os.getenv("JIRA_BASE_URL", "https://ri****.atlassian.net"),
        username=os.getenv("JIRA_USERNAME"), # Removed default value
        api_token=os.getenv("JIRA_API_TOKEN"), # Removed default value
